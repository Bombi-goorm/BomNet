...
@Component
public class AnnualTimeStringProvider implements TimeStringProvider {

	private final TimeGenerator timeGenerator;

	public AnnualTimeStringProvider(@Qualifier("annualPriceTimeGenerator") TimeGenerator timeGenerator) {
