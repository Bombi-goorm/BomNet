...
@Component
public class SpecialWeatherTimeStringProvider implements TimeStringProvider {

	private final TimeGenerator timeGenerator;

	public SpecialWeatherTimeStringProvider(@Qualifier("specialWeatherTimeGenerator") TimeGenerator timeGenerator) {
