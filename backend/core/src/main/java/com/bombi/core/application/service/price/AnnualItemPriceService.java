...
import com.bombi.core.common.utils.time.provider.AnnualTimeStringProvider;
...
public class AnnualItemPriceService {
	...
	private final AnnualTimeStringProvider timeStringProvider;
	private final AnnualVarietyPriceCollector annualVarietyPriceCollector;

	public AnnualItemPriceService(AnnualTimeStringProvider timeStringProvider,
