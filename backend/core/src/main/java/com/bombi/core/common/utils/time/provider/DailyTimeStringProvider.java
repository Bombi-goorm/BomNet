...
@Component
public class DailyTimeStringProvider implements TimeStringProvider {

	private final TimeGenerator timeGenerator;

	public DailyTimeStringProvider(@Qualifier("dailyPriceTimeGenerator") TimeGenerator timeGenerator) {
