...
@Component
public class ForecastTimeStringProvider implements TimeStringProvider {

	private final TimeGenerator timeGenerator;

	public ForecastTimeStringProvider(@Qualifier("forecastTimeGenerator") TimeGenerator timeGenerator) {
