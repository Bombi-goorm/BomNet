...
public class SecurityConfig {
    ...
    private static final String[] PUBLIC_API_URL = { // 인증 없이도 접근 가능한 경로
            "/core/health", "/bigquery/data", "/gcs/data", "/weather/special", "/naver/news", "/best/price", "/core/home", "/weather/forecast", "/soil/character", "/soil/chemical", "/farm", "/product/chart/node", "/product/chart/link", "/product/chart"
    };
