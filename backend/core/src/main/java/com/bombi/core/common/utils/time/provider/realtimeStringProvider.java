...
@Component
public class realtimeStringProvider implements TimeStringProvider {

	private final TimeGenerator timeGenerator;

	public realtimeStringProvider(@Qualifier("realtimeGenerator") TimeGenerator timeGenerator) {
